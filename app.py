    ...
    try:
        ...
        if check_main_order_status(symbol) != True and check_position_status(symbol) != True:
            if side == "BUY":
                ...
                order = client.futures_create_order(symbol=symbol,positionSide="SHORT", type="STOP_MARKET",stopPrice=high_price, quantity=quantity, timeInForce=TIME_IN_FORCE_GTC,)
